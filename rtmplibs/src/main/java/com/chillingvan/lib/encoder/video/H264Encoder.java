...
public class H264Encoder {
    ...
    public H264Encoder(final StreamPublisher.StreamPublisherParam params, final EglContextWrapper eglCtx) throws IOException {
        this(params, eglCtx, null);
    }

    public H264Encoder(final StreamPublisher.StreamPublisherParam params, final EglContextWrapper eglCtx, VirtualDisplay display) throws IOException {
...
//        MediaFormat format = MediaFormat.createVideoFormat(MIME_TYPE, params.width, params.height);
        ...
        if (null != display) {
            display.setSurface(mInputSurface);
        }
        mEncoder.start();
