...
public class StreamPublisher {
    ...
    public void prepareEncoder(final StreamPublisherParam param, H264Encoder.OnDrawListener onDrawListener) {
       prepareEncoder(param,null,onDrawListener);
    }

    public void prepareEncoder(final StreamPublisherParam param, VirtualDisplay display, H264Encoder.OnDrawListener onDrawListener) {
        this.param = param;

        try {
            h264Encoder = new H264Encoder(param, eglCtx,display);
